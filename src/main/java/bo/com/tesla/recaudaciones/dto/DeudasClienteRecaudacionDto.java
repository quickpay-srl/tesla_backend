...
public class DeudasClienteRecaudacionDto {
	...
	public BigDecimal totalSinComisionRecaudacion;
	...
	public DeudasClienteRecaudacionDto() {
	...
	public DeudasClienteRecaudacionDto(Long archivoId, String codigoCliente, String nroFactura, String servicio,
									   String tipoServicio, String periodo, String estado,
									   String nombreClientePago, Date fechaCreacion, BigDecimal total, String nombreRecaudadora, BigDecimal comision, BigDecimal comisionRecaudacion, String cajero, String nombre, String metodoPago) {
		...
		this.totalSinComisionRecaudacion=total.subtract(comisionRecaudacion);
		this.cajero=cajero;
		this.nombre = nombre;
		this.metodoPago = metodoPago;
